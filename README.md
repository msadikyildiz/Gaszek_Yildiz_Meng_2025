...
graph layouts, BioRender for the Fig 1 schematics) or by collaborators (Fig 6 / S6 DCA, S18),
and Fig 1F and S1 are retained from the submission with no in-repo generator; these cannot be
